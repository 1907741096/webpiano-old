...
<header>
	...
	<div class="info">
		<?php if($user!=''): ?><div class="info_face">
				<img src="<?php echo ($user["face"]); ?>">
				<div><?php echo ($user["name"]); ?></div>
			</div>
			<div class="info_main">
				<iframe src="index.php?c=info&a=main" frameborder="0" name="mainFrame" width="100%" height="800"></iframe>
			</div>
		<?php else: ?>
			<div class="please_login">please login</div><?php endif; ?>
	</div>
